...
v1.3.14 Release: https://github.com/subchen/frep/releases/tag/v1.3.14

- Linux

    ```
    curl -fSL https://github.com/subchen/frep/releases/download/v1.3.14/frep-1.3.14-linux-amd64 -o /usr/local/bin/frep
    chmod +x /usr/local/bin/frep

    # centos / redhat
    yum install https://github.com/subchen/frep/releases/download/v1.3.14/frep-1.3.14-204.x86_64.rpm

    # ubuntu
    curl -fSL https://github.com/subchen/frep/releases/download/v1.3.14/frep_1.3.14-204_amd64.deb -o frep_1.3.14-204_amd64.deb
    dpkg -i frep_1.3.14-204_amd64.deb
    ```
...
- Windows
    ...
    ```
    wget https://github.com/subchen/frep/releases/download/v1.3.14/frep-1.3.14-windows-amd64.exe
    ```
